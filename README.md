...
- **倍速切换**：在倍速切换值与当前倍速之间来回切换（默认A键）
- **增加/减少倍速**：按下按步进量增减倍速（默认X/Z键）
- **倍速提示浮层**：调节倍速时在播放器中显示当前倍速；长按倍速期间持续显示，松开即消失
...
- **倍速切换键（默认A）**：在倍速切换值与当前倍速之间来回切换
- **增加倍速键（默认X）/ 减少倍速键（默认Z）**：按步进量增减倍速
- **注意**：快捷键仅在B站视频页面有效，在输入框中打字时不会触发
